...
namespace DevIO.Api.Controllers
{
    ...
    public class ProdutosController : MainController
    {
        ...
        {
            return _mapper.Map<IEnumerable<ProdutoViewModel>>(await _produtoRepository.ObterProdutosFornecedoresAsync());
        }
        ...
        {
            return _mapper.Map<ProdutoViewModel>(await _produtoRepository.ObterProdutoFornecedorAsync(id));
        }
    }
}
